...
for i in a:
    ...
    for j in s:
        ...
        for k in nz:
            l1 = []
            l1.append(random.choice(list(k)))
            # for l in l1:
           # print(l1)
#l2 = []
#l2.append(l1)
...
#encode = y1.transform(y)
##y1.inverse_transform(encode)
#print(y1)

from sklearn.model_selection import train_test_split
from sklearn.neighbors import KNeighborsClassifier  
from sklearn import metrics
X_train=['1956','1616','102','1033','4313']
X_train,X_test,y_train,y_test=train_test_split(X,y1,test_size=0.02,random_state=0) 
